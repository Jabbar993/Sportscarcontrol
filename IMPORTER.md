...
If Fastest Laps PDF is missing,
classification may provide fallback fastest laps where available.
...
If unavailable,
the importer should fall back to Race Classification data whenever possible.
